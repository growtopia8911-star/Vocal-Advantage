...
**Tasks 5 and 9 are complete** (2026-08-19, on the Mac) and their rows above are resolved. What is left in this table is Tasks 7 and 10 — both Windows-only, both for the PC.
